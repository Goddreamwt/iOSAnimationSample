...
//  该软件按“原样”提供，没有任何明示或暗示 保证： 在任何情况下，作者不对任何损害赔偿责任
//  arising from the use of this software.产生于使用本软件。
//
//  Permission is granted to anyone to use this software for any purpose,允许任何人将此软件用于任何目的
//  including commercial applications, and to alter it and redistribute it。包括商业应用，并改变它并重新分配
